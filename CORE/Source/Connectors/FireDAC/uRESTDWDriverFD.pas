...
Var
 ...
 Begin
  ...
  For I := 0 To Params.Count -1 Do
   ...
   End;
 End;
 Procedure BuildReflectionChanges(Var ReflectionChanges : String); //Todo
 Begin
                  ...
                  If Lowercase(MassiveDataset.AtualRec.UpdateFieldChanges[I]) <> Lowercase(DWFieldBookmark) Then
                   Begin
                    ...
                    Else
                     Begin
                      If vFields = '' Then
                       vFields     := MassiveDataset.AtualRec.UpdateFieldChanges[I]
                      Else
                       vFields     := vFields    + ', '  + MassiveDataset.AtualRec.UpdateFieldChanges[I];
                     End;
                   End;
                 End;
                bPrimaryKeys := MassiveDataset.PrimaryKeys;
   ...
   If (MassiveDataset.ReflectChanges) And
    ...
    Begin
     ...
     Finally
      ...
      BuildReflectionChanges(vResultReflection);
      Query.Close;
     End;
    End
   Else
