...
Const
 ...
 TMassiveFormatJSON    = '{"%s":"%s", "%s":"%s", "%s":"%s", "%s":"%s", "%s":"%s", "%s":[%s], "reflectionchanges":"%s"}';
 ...
 AssyncCommandMSG     = 'AssyncCommand Executed';
 ...
 DWRelease            = '1741';
 DWCodeProject        = 'Pulstar';
 DWVERSAO             = '1.4.3.' + DWRelease + '(' + DWCodeProject + ')';
